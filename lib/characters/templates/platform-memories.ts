...
export const PLATFORM_CONTEXT_MEMORIES: AgentTemplateMemory[] = [
  ...
  },
  {
    category: "domain_knowledge",
    content:
      "The Selene UI sidebar shows: chat history (past conversations), scheduled tasks (cron/interval/one-time jobs), and connected channels (Telegram/WhatsApp/Slack/Discord integrations). 'Channels' in Selene means messaging platform integrations, not social media.",
    reasoning: "Clarifies channel terminology in the Selene UI.",
  },
  {
    category: "domain_knowledge",
    content:
...
export function getDefaultSeleneMemories(): AgentTemplateMemory[] {
