...
async function main() {
    ...
    console.log("Test 5: Real-world example (Composio V3)");
    ...
    const env5 = { 
        COMPOSIO_API_KEY: "sk-composio-abc123xyz",
        COMPOSIO_CONNECTION_ID: "conn_789"
    };
    ...
    try {
        ...
        const checks = [
            resolved5.url === "https://backend.composio.dev/v3/mcp/conn_789/mcp",
