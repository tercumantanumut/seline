...
import { Save, X, Loader2, Globe, ArrowLeft, CalendarClock } from "lucide-react";
...
import { TIMEZONES, SectionHeader, VariableHelpPanel } from "./schedule-form-helpers";
                        ...
                        <section className="flex-1 flex flex-col space-y-4">
                            <div className="flex flex-col space-y-4">
                                ...
                                <VariableHelpPanel
                                    ...
                                    onToggle={() => setShowVariableHelp(!showVariableHelp)}
                                />
                            </div>
