  ...
  return (
    <div className="flex flex-col gap-6 p-6 max-w-4xl mx-auto bg-terminal-cream min-h-full">
      ...
      <Dialog open={mcpToolEditorOpen} onOpenChange={setMcpToolEditorOpen}>
        <DialogContent className="sm:max-w-4xl bg-terminal-cream h-[90vh] flex flex-col p-0 overflow-hidden [&_.dialog-close-default]:hidden">
          {/* Close button - positioned absolutely */}
          <button
            onClick={() => setMcpToolEditorOpen(false)}
            className="absolute right-6 top-6 z-50 rounded-sm p-1.5 opacity-70 hover:opacity-100 hover:bg-terminal-border/30 transition-all"
            aria-label="Close"
          >
          ...
          {/* Header */}
          <div className="px-6 pt-6 pb-4 pr-16 flex-shrink-0 border-b border-terminal-border/20">
            <DialogTitle className="font-mono text-terminal-dark flex items-center gap-2">
